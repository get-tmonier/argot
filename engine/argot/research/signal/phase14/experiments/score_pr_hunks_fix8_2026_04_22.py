# engine/argot/research/signal/phase14/experiments/score_pr_hunks_fix8_2026_04_22.py
"""Phase 14 Exp #7 Step P — Score PR hunks with fix8 (data-dominant + comment-only autogen filter).

Reads:  real_pr_base_rate_prs_with_sha_2026_04_22.jsonl   (cached, with mergeCommit SHAs)
Writes: real_pr_base_rate_hunks_fix8_2026_04_22.jsonl

Builds on fix7 and adds: (A) data-dominant calibration exclusion, (B) comment-only autogen marker matching.
...
Usage:
    uv run python engine/argot/research/signal/phase14/experiments/score_pr_hunks_fix8_2026_04_22.py
    uv run python engine/argot/research/signal/phase14/experiments/score_pr_hunks_fix8_2026_04_22.py --sanity-check
"""
...
_HUNKS_JSONL = _SCRIPT_DIR / "real_pr_base_rate_hunks_fix8_2026_04_22.jsonl"
