# engine/argot/research/signal/phase14/experiments/score_pr_hunks.py
"""Phase 14 Exp #5 — Score PR hunks using SequentialImportBpeScorer.

Reads:  real_pr_base_rate_prs_2026_04_22.jsonl
Writes: real_pr_base_rate_hunks_2026_04_22.jsonl

Calibration: seed 0, n=100 hunks from .argot/research/repos/fastapi source.
Scoring:     V1 SequentialImportBpeScorer (unmodified from exp #2c).
Extraction:  file-start-to-hunk-end on current HEAD of cached repo.

Usage:
    uv run python engine/argot/research/signal/phase14/experiments/score_pr_hunks.py
"""
