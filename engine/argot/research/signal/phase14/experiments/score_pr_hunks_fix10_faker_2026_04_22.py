# engine/argot/research/signal/phase14/experiments/score_pr_hunks_fix10_faker_2026_04_22.py
"""Phase 14 Task #7 — Score faker PR hunks with fix10 (hunk-scope Stage 1).

Reads:  faker_real_pr_base_rate_prs_2026_04_22.jsonl
Writes: real_pr_base_rate_hunks_fix10_faker_2026_04_22.jsonl

fix10 change over fix9: Stage 1 now only inspects imports added in the hunk itself.
Primary goal: confirm PR #2259 FP (string edit in factory.py) is gone.  Expected:
Stage 1 count drops from 1 to 0.

Usage:
    uv run python engine/argot/research/signal/phase14/experiments/score_pr_hunks_fix10_faker_2026_04_22.py
    uv run python engine/argot/research/signal/phase14/experiments/score_pr_hunks_fix10_faker_2026_04_22.py --sanity-check
"""
...
_HUNKS_JSONL = _SCRIPT_DIR / "real_pr_base_rate_hunks_fix10_faker_2026_04_22.jsonl"
