# engine/argot/research/signal/phase14/experiments/mine_rich_prs_2026_04_22.py
"""Phase 14 Exp #7 Cross-corpus — Mine merged Rich PRs from the last year.

Fetches merged PRs from Textualize/rich between 2025-04-22 and 2026-04-22,
excluding bots, keeping only PRs that touch at least one Python file under
rich/ (the source tree, not tests/).

Includes mergeCommit.oid so the scoring script can use it directly.

Output: rich_real_pr_base_rate_prs_2026_04_22.jsonl

Usage:
    uv run python engine/argot/research/signal/phase14/experiments/mine_rich_prs_2026_04_22.py
"""
...
_OUT = _SCRIPT_DIR / "rich_real_pr_base_rate_prs_2026_04_22.jsonl"
...
def main() -> None:
    ...
    print(
        ...
        f"{n_bots} bots, {n_no_source_py} no rich/*.py",
        flush=True,
    )
