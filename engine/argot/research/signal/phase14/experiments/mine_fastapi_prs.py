# engine/argot/research/signal/phase14/experiments/mine_fastapi_prs.py
"""Phase 14 Exp #5 — Mine merged FastAPI PRs from the last year.

Fetches merged PRs from tiangolo/fastapi between 2025-04-22 and 2026-04-22,
excluding bots, keeping only PRs that touch at least one Python file under
fastapi/ (the source tree, not tests/).

Output: real_pr_base_rate_prs_2026_04_22.jsonl

Usage:
    uv run python engine/argot/research/signal/phase14/experiments/mine_fastapi_prs.py
"""
...
_OUT = _SCRIPT_DIR / "real_pr_base_rate_prs_2026_04_22.jsonl"
...
def main() -> None:
    ...
    result = subprocess.run(
        [
            ...
            "merged",
            "--json",
            "number,title,author,mergedAt,url,files",
            "--limit",
            "500",
        ],
        capture_output=True,
    ...
    print(
        ...
        f"{n_bots} bots, {n_no_source_py} no fastapi/*.py",
        flush=True,
    )
