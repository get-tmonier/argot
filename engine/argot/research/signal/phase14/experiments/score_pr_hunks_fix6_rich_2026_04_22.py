# engine/argot/research/signal/phase14/experiments/score_pr_hunks_fix6_rich_2026_04_22.py
"""Phase 14 Exp #7 Cross-corpus — Score rich PR hunks with fix6 (prose masking).

Reads:  rich_real_pr_base_rate_prs_2026_04_22.jsonl
Writes: real_pr_base_rate_hunks_fix6_rich_2026_04_22.jsonl

Mirror of score_pr_hunks_fix6_2026_04_22.py adapted for Textualize/rich.
Per-PR recalibration + prose masking unchanged from FastAPI fix6.

Usage:
    uv run python engine/argot/research/signal/phase14/experiments/score_pr_hunks_fix6_rich_2026_04_22.py
    uv run python engine/argot/research/signal/phase14/experiments/score_pr_hunks_fix6_rich_2026_04_22.py --sanity-check
"""
...
_HUNKS_JSONL = _SCRIPT_DIR / "real_pr_base_rate_hunks_fix6_rich_2026_04_22.jsonl"
