# engine/argot/research/signal/phase14/experiments/score_pr_hunks_fix10_rich_2026_04_22.py
"""Phase 14 Task #7 — Score rich PR hunks with fix10 (hunk-scope Stage 1).

Reads:  rich_real_pr_base_rate_prs_2026_04_22.jsonl
Writes: real_pr_base_rate_hunks_fix10_rich_2026_04_22.jsonl

fix10 change over fix9: Stage 1 now only inspects imports added in the hunk itself.
Expected: Rich Stage 1 count may drop from 4 if any of those 4 were file-level
contamination.  The _unicode_data/__init__.py flag in PR #3930 must survive (that
hunk actually adds new imports).

Usage:
    uv run python engine/argot/research/signal/phase14/experiments/score_pr_hunks_fix10_rich_2026_04_22.py
    uv run python engine/argot/research/signal/phase14/experiments/score_pr_hunks_fix10_rich_2026_04_22.py --sanity-check
"""
...
_HUNKS_JSONL = _SCRIPT_DIR / "real_pr_base_rate_hunks_fix10_rich_2026_04_22.jsonl"
