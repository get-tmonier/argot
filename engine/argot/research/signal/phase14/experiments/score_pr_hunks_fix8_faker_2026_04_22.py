# engine/argot/research/signal/phase14/experiments/score_pr_hunks_fix8_faker_2026_04_22.py
"""Phase 14 Prompt S — Score faker PR hunks with fix8 (data-dominant + comment-only autogen filter).

Reads:  faker_real_pr_base_rate_prs_2026_04_22.jsonl
Writes: real_pr_base_rate_hunks_fix8_faker_2026_04_22.jsonl
...
Usage:
    uv run python engine/argot/research/signal/phase14/experiments/score_pr_hunks_fix8_faker_2026_04_22.py
    uv run python engine/argot/research/signal/phase14/experiments/score_pr_hunks_fix8_faker_2026_04_22.py --sanity-check
"""
...
_HUNKS_JSONL = _SCRIPT_DIR / "real_pr_base_rate_hunks_fix8_faker_2026_04_22.jsonl"
