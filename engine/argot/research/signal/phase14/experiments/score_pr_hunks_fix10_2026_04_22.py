# engine/argot/research/signal/phase14/experiments/score_pr_hunks_fix10_2026_04_22.py
"""Phase 14 Task #7 — Score FastAPI PR hunks with fix10 (hunk-scope Stage 1).

Reads:  real_pr_base_rate_prs_with_sha_2026_04_22.jsonl
Writes: real_pr_base_rate_hunks_fix10_2026_04_22.jsonl

fix10 change over fix9: Stage 1 now only inspects imports added in the hunk itself,
ignoring file-level imports.  A pure string/comment edit in an import-heavy file no
longer fires Stage 1.  Expected: FastAPI Stage 1 count stays 0 (was 0 in fix9 — no
Stage 1 flags exist for FastAPI).

Usage:
    uv run python engine/argot/research/signal/phase14/experiments/score_pr_hunks_fix10_2026_04_22.py
    uv run python engine/argot/research/signal/phase14/experiments/score_pr_hunks_fix10_2026_04_22.py --sanity-check
"""
...
_HUNKS_JSONL = _SCRIPT_DIR / "real_pr_base_rate_hunks_fix10_2026_04_22.jsonl"
