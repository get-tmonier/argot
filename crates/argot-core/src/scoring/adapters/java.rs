...
mod tests {
    ...
    fn generated_annotation_and_header_marker_detected() {
        ...
        assert!(adapter.is_auto_generated(annotated, &crate::config::default_generated_markers()));
        let header = "// This file was automatically generated. Do not edit.\nclass Foo {}\n";
        assert!(adapter.is_auto_generated(header, &crate::config::default_generated_markers()));
        let hand_written = "// A normal class.\nclass Foo {}\n";
        assert!(
            !adapter.is_auto_generated(hand_written, &crate::config::default_generated_markers())
        );
    }
