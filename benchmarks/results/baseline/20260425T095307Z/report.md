...
Breaks that didn't trip the scorer (threshold 3.8424):

- **dict_render_1** (`print_manual`) — score 1.6069, 2.2356 below threshold, reason: `none`
...
- **faker_js_foreign_rng_3** (`foreign_rng`) — score 0.5200, 4.3407 below threshold, reason: `none`
...
| uncaught | 0.0% | 0/8 | Scorer currently misses — known gap |
