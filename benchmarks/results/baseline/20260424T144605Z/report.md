...
Generated: 2026-04-24T15:07:57.300759+00:00
...
| hono | typescript | 0.8312 | 71.7% | 0.4% | -7.471 | 17 | 54717 | 4.277 |
| ink | typescript | 0.9899 | 86.7% | 0.4% | -4.633 | 17 | 16678 | 4.826 |
...
- **FP rate on real PR hunks:** 0.9% (304/75996)
...
- **FP rate on real PR hunks:** 0.8% (252/79623)
...
| routing | 66.7% | 2/3 | 2.238 | 0.819 | 4.713 | hono_routing_1, hono_routing_2, hono_routing_3 |
...
| hono_routing_2 | routing | 1.183 | ✓ | call_receiver | breaks/break_routing_2.ts | 6–14 | Router().route(path).get().post().delete() chain composition |
...
| uncaught | 16.7% | 1/6 | Scorer currently misses — known gap |
...
| uncaught | 0.0% | 0/2 | Scorer currently misses — known gap |
...
- **Recall (mean across categories):** 95.0%
- **FP rate on real PR hunks:** 0.4% (199/68598)
